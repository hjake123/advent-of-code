...
# Create a modulo base that encompasses all of the test_modulos. It could probably be lower but this works.
multi_mod = 1
for m in monkeys:
    multi_mod *= m.test_modulo

for i in range(10000):
    for m in monkeys:
        m.take_turn()
    if (i-1) % 1000 == 0 or i == 19:
        print([m.activity for m in monkeys], sep=',')
